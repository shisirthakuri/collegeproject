...
const ScholarShips = () => {
  return (
   ...
   <ScholarTable/>
   <h1 className='font-serif text-gray-600 leading-6 tracking-wider text-md ml-40 '> # Above table scholarships criteria is apply for <span className='bg-gray-300 p-1'>all classes</span></h1>
    </div>
  )
}
